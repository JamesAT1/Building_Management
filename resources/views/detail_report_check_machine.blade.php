            ...
            <div class="card">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h5>รอบ <?php if ($machine_rooms_check_day->shift_worker_time == 1){ echo "เช้า"; }elseif ($machine_rooms_check_day->shift_worker_time == 2){ echo "บ่าย"; }elseif($machine_rooms_check_day->shift_worker_time == 3) { echo "ค่ำ"; } ?></label>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <p>สถานะ: {{$machine_rooms_check_day->machine_rooms_check_day_status}}</p>
                                @if($machine_rooms_check_day->machine_rooms_check_day_status == "พบปัญหาและแก้ไขแล้ว" || $machine_rooms_check_day->machine_rooms_check_day_status == "พบปัญหา")
                                    <p>ปัญหาที่พบ: {{$machine_rooms_check_day->machine_room_problem}}</p>
                                <hr />
                                @endif
                                <div class="row">
                                    {{-- @if(false)
                            ...
                            @if($machine_rooms_check_day->img_for_checked != null && $machine_rooms_check_day->img_for_checked != '')
                            <div class="col-12">
                            <p>รายละเอียด: @if ($machine_rooms_check_day->machine_rooms_check_day_description != null && $machine_rooms_check_day->machine_rooms_check_day_description != '') {{$machine_rooms_check_day->machine_rooms_check_day_description}} @else ไม่มี @endif</p>
                            </div>
                            <div class="col-12">
                                <hr />
                            </div>
                            <div class="col-10">
                                ...
                                <div class="col-2">
                                    <img onclick="show_img('{{'img/img_for_checked/ตรวจห้องเครื่องวันที่ '.(new datetime($date_check))->format('d-m-Y').'/'.$machine_rooms_check_day->img_for_checked}}')" width="100%" src="{{asset('img/img_for_checked/ตรวจห้องเครื่องวันที่ '. (new datetime($date_check))->format('d-m-Y') .'/'.$machine_rooms_check_day->img_for_checked)}}"/>
                                </div>
                            @endif
                        </div>
                    </div>
                </div>
                {{-- <a href="{{url('row_report_check_machine')}}" class="btn btn-light form-control">ย้อนกลับ</a> --}}
                <br />
            </div>
        <div class="col-1">
        </div>
