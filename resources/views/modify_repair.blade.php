                ...
                <form action="{{url('/process_repair_modify')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <label>รายการ</label>
                                <textarea class="form-control" rows="5" name="list_report" placeholder="กรุณากรอกรายการ" required>{{$repair[0]->list_report}}</textarea>
                                <br />
                            </div>
                            <div class="col-12">
                            <div class="card">
                            ...
                            <div class="col-12">
                            <br />
                                <button type="submit" id="submit" class="form-control btn btn-info">อัพเดทรายการ</button>
